...
describe('SubscriptionService', () => {
    ...
    beforeEach(() => {
        ...
        (paymentService.getProviderInstance as jest.Mock).mockReturnValue(mockPaymentProvider);
    });
    ...
    describe('createSubscription', () => {
        ...
        it('should create a subscription successfully', async () => {
            ...
            (prisma.subscription.findUnique as jest.Mock).mockResolvedValue(null); // No existing sub
        ...
        it('should fail if tier does not exist', async () => {
            ...
            await expect(
                subscriptionService.createSubscription(mockUser.id, mockCreator.id, 'invalid-tier')
        ...
        it('should fail if user already has active subscription', async () => {
            ...
            await expect(
                subscriptionService.createSubscription(mockUser.id, mockCreator.id, mockTier.id)
