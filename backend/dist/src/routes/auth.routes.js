 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/refresh', (0, validation_middleware_1.validate)(auth_schema_1.refreshTokenSchema), authController.refresh);
/**
 * @swagger
 * /auth/logout:
 *   post:
 ...
 *                   example: true
 */
router.post('/logout', (0, validation_middleware_1.validate)(auth_schema_1.refreshTokenSchema), authController.logout);
/**
 * @swagger
 * /auth/me:
 *   get:
