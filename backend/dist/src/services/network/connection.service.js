...
class ConnectionService {
     ...
     */
    async calculateStrength(userAId, userBId) {
     ...
     */
    async createOrUpdateConnection(userAId, userBId, relationshipType) {
     ...
     */
    async getRelationshipTimeline(userAId, userBId) {
        const [smallerId, largerId] = [userAId, userBId].sort();
