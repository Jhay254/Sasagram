...
class VersionService {
     ...
     */
    async createVersion(chapterId, userId, changeDescription) {
        ...
        logger_1.default.info(`Version created for chapter ${chapterId}`, {
     ...
     */
    async getVersion(chapterId, versionId) {
     ...
     */
    async revertToVersion(chapterId, versionId, userId) {
        ...
        logger_1.default.info(`Chapter reverted to version ${versionId}`, {
            chapterId,
            userId,
        });
     ...
     */
    async compareVersions(chapterId, versionId1, versionId2) {
     ...
     */
    async saveVersions(chapterId, versions) {
        const chapter = await prisma.livingChapter.findUnique({
            where: { id: chapterId },
        });
        if (!chapter)
